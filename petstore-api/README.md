...
- Build date: 2024-10-18T17:05:33.292100505Z[Etc/UTC]
- Generator version: 7.10.0-SNAPSHOT



This autogenerated project defines an API crate `petstoreapi` which contains:
...
#[async_trait]
impl petstoreapi::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    // Init Axum router
    let app = petstoreapi::server::new(Arc::new(ServerImpl));
