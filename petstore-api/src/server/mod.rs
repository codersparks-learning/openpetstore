    ...
    A: apis::pet::Pet + apis::store::Store + apis::user::User + 'static,
{
    ...
    Router::new()
        ...
        .route("/v3/pet/:pet_id/uploadImage",
...
/// FindPetsByStatus - GET /v3/pet/findByStatus
#[tracing::instrument(skip_all)]
...
/// FindPetsByTags - GET /v3/pet/findByTags
#[tracing::instrument(skip_all)]
...
/// UpdatePetWithForm - POST /v3/pet/{petId}
#[tracing::instrument(skip_all)]
...
/// UploadFile - POST /v3/pet/{petId}/uploadImage
#[tracing::instrument(skip_all)]
...
/// DeleteOrder - DELETE /v3/store/order/{orderId}
#[tracing::instrument(skip_all)]
...
/// GetInventory - GET /v3/store/inventory
#[tracing::instrument(skip_all)]
...
/// GetOrderById - GET /v3/store/order/{orderId}
#[tracing::instrument(skip_all)]
...
/// PlaceOrder - POST /v3/store/order
#[tracing::instrument(skip_all)]
    ...
    A: apis::store::Store,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                ...
                                                apis::store::PlaceOrderResponse::Status405_InvalidInput
                                                => {
                                                  let mut response = response.status(405);
                                                  response.body(Body::empty())
                                                },
...
/// CreateUsersWithListInput - POST /v3/user/createWithList
#[tracing::instrument(skip_all)]
...
/// DeleteUser - DELETE /v3/user/{username}
#[tracing::instrument(skip_all)]
...
/// GetUserByName - GET /v3/user/{username}
#[tracing::instrument(skip_all)]
...
/// UpdateUser - PUT /v3/user/{username}
#[tracing::instrument(skip_all)]
